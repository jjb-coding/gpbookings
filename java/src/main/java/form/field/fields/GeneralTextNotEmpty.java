...
public class GeneralTextNotEmpty extends ValidatedText {
	/**
	 ...
	 */
	public GeneralTextNotEmpty(JTextField partner, IReflectsStatus errorReflection) {
	...
	public Status Validate(String in) {
		...
		if (in.length() == 0)
			return Status.FIELD_TEXT_EMPTY;
		return null;
	}
