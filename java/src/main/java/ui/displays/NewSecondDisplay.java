...
import ui.controllers.NewSecondController;
...
public class NewSecondDisplay extends JPanel
	implements IDisplay {
	...
	public NewSecondDisplay(Node _parent) {
		// Super
		super();
		// Set parent
		this._parent = _parent;
		// Inject
		NewSecondController _controller = (NewSecondController)inject(InjectableEnum.NEW_SECOND_CONTROLLER);
        ...
        mainPanel.setBorder(BorderFactory.createEmptyBorder(30, 65, 30, 65));
